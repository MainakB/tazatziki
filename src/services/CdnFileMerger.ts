...
(() => {
  try {
    ...
    if (fs.existsSync(originalCucumberReportHtmlFile)) {
      ...
      fs.copyFileSync(originalCucumberReportHtmlFile, newCucumberReportHtmlFile);
      ...
      // Respond
      files.set('assets/js/respond.min.js', 'https://cdnjs.cloudflare.com/ajax/libs/respond.js/1.4.2/respond.min.js');

      // jQuery
      files.set('assets/js/jquery-3.2.1.min.js', 'https://code.jquery.com/jquery-3.2.1.min.js');
      ...
      files.set('assets/js/bootstrap.min.js', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js');
      ...
      files.set('assets/js/jquery.dataTables.min.js', 'https://cdn.datatables.net/1.10.15/js/jquery.dataTables.min.js');
      ...
      // Chart
      files.set('assets/js/Chart.min.js', 'https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.5.0/Chart.js');
